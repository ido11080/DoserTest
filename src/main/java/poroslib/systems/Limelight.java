...
public class Limelight
{
    ...
    private double hightFromFloor = 0;
    ...
    public double getDistanceFromTarget(double targetHeight, double limelightHeight, double limelightAngle) {
        double yAngle = getVerticalOffset() +2.75
        
        ;
        double angle = limelightAngle + yAngle;
        ...
        double h = (targetHeight-limelightHeight);
        // System.out.println("distance: " + (h / Math.tan(radAng)));
        return h / Math.tan(radAng);
    }
}